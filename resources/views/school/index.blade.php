                ...
                <div class="card">
                    ...
                    <div class="card-body pt-3">
                        <div class="card-toolbar d-flex justify-content-end responsive-active-header" >
                            <a href="{{ route('school.create') }}" class="btn btn-light-success btn-icon-success create-new log-ticket-button">
                                <i class="fas fa-plus icon-2x"></i>
                                <span class="fw-bold fs-5">Okul Ekle</span>
                            </a>
                        </div>
                        <!-- Table -->
                                ...
                                @foreach($data as $key => $value)
                                    <tr>
                                        ...
                                        <td class="text-end w-100px">
                                            <a href="{{ route('school.edit', $value->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 bg-secondary" data-bs-toggle="tooltip" data-bs-placement="left" title="Düzenle">
                                                <i class="fas fa-pen"></i>
                                            </a>
                                            <a href="{{route('school.destroy',$value->id)}}" class="delete-confirm btn btn-icon btn-bg-light btn-active-color-danger btn-sm  bg-secondary" data-bs-toggle="tooltip" data-bs-placement="right" title="Sil">
                                                <i class="fas fa-trash"></i>
                                            </a>
                                            <a href="{{route('school.show',$value->id)}}" class="btn btn-icon btn-bg-light btn-active-color-danger btn-sm  bg-secondary" data-bs-toggle="tooltip" data-bs-placement="right" title="Sil">
